...
public class TakeQuiz extends BaseAuthentication {
    ...
    private Hashtable<String, ArrayList<Question>> questions = new Hashtable<String, ArrayList<Question>>();
    private Hashtable<String, Long> startTimes = new Hashtable<String, Long>();
    ...
    protected void processGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (request.getParameter("number") == null) {
                ...
                int number = -1;
                //handle when number not integer
                try {
