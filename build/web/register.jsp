        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <form action="register" method="POST">
                    ...
                    <input class="margin_username" type="text" name="username" value="${param.username}">
                    <br>
                    <p class="label">Password:</p>
                    <input class="margin_password" type="password" name="password" value="${param.password}">
                    <br>
                    ...
                    <input class="margin_email" type="text" name="email" value="${param.email}">
                    <br>
